import { NowPlayingSong } from "pages/api/nowplaying";
    ...
    return (
        ...
        {data?.isPlaying && data?.songUrl ? (
         <p className="text-sm text-gray-500 truncate dark:text-gray-400 max-w-max">
            ...
            <svg className="flex-none w-5 h-5 fill-current text-gray-700 dark:text-gray-200 " viewBox="0 0 168 168" text-gray-700>
            <path
